...
public class AccidentService {
    ...
    public void executePythonScripts(String year, String month) throws IOException, InterruptedException {
        ...
        ProcessBuilder pbSearch = new ProcessBuilder("python3", "/scripts/search.py", year, month);
        // 設定工作目錄
        ...
        if (exitCode != 0) {
            throw new RuntimeException("Map Python script failed with exit code: " + exitCode);
        }
    }
